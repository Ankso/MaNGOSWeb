...
/** 
*
* mcp.php [Colloquial Spanish [es_x_tu]]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'MERGE_POSTS_CONFIRM'	=> '¿Estás seguro de que deseas unir los mensajes seleccionados?',
	'MERGE_TOPIC_EXPLAIN'	=> 'Usando el siguiente formulario puedes unir los mensajes seleccionados en otro tema. Estos mensajes no serán reordenados y aparecerán como si los usuarios los hubiesen publicado en el nuevo tema.<br />Por favor introduce el id del tema de destino o haz clic en el botón "Seleccionar" para buscar uno',
