...
/**
*
* recaptcha [Colloquial Spanish [es_x_tu]]
*
* @package language
...
$lang = array_merge($lang, array(
	'RECAPTCHA_LANG'				=> 'es',
	'RECAPTCHA_NOT_AVAILABLE'		=> 'Para poder usar reCaptcha, debes crear una cuenta en <a href="http://recaptcha.net">reCaptcha.net</a>.',
	...
	'RECAPTCHA_PUBLIC_EXPLAIN'		=> 'Tu Clave Pública reCaptcha. Se pueden obtener las claves en <a href="http://recaptcha.net">reCaptcha.net</a>.',
	'RECAPTCHA_PRIVATE'				=> 'Clave Privada reCaptcha',
	'RECAPTCHA_PRIVATE_EXPLAIN'		=> 'Tu Clave Privada reCaptcha. Se pueden obtener las claves en <a href="http://recaptcha.net">reCaptcha.net</a>.',
